...
def main():
    ...
    parser.add_argument('--data_root', type=str, required=False, default='../data')
    ...
    te_set = Scene15Set(root_dir_path=args.data_root, train=False, vgg='vgg' in model_cfg.name)
